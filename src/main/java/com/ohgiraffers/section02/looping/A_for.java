...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        /* 필기. 1부터 10까지 씩 증가시키면서(10번) i 값을 출력하는 기본 반복문*/

        //       int a = 1;
        //      System.out.println("a = " + a);
        //      int b = 2;    // 10개이면 10개를 만들어야 한다.

        for (int i = 1; i <= 10; i++) {     // i = 11 이면 조건식이 맞지 않기 때문에 출력이 되지 않는다.
            System.out.println(i);      // 증감식이 없으면 1만 무한 반복이 된다.(컴퓨터 다운가능성 있다..ㅎ)
        }                              // 조건식이 없으면 무한 증감 시킨다.
...
//        System.out.println("5명의 학생 이름을 입력 받고 출력하는 기능 완료!! ");
        ...
        * */
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            //스캐너를 조건문 안에 안넣는 이유 : 할때마다 식을 계속 초기화 해서 메모리 낭비
            // 스캐너를 하나 만들어 놨으니 재사용 하는 거다.
    ...
    public void testForExample3() {
        ...
        int random = (int) (Math.random() * 6) + 5;   // Math.random 은 실수반환 된다.
        ...
        if (random == 5) {             // 난수가 5이면 1-5까지 더해주어야 한다.
            sum += 1;
            sum += 2;
            sum += 3;
            sum += 4;
        ...
        System.out.println("1부터 " + "까지의 합은 " + sum);
    ...
    public void testForExample4(){
        ...
        /*필기.
         *  숫자 두 개를 입력 받아 작은 수 에서 큰 수 까지의 합계를 구하시오
...
//            System.out.println(dan + "*" + 9 + "=" + (dan * 9));   // 공통점:
